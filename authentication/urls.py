...
from .views import LoginView, CustomUserRegister, user_profile, RefreshTokenView, UserRegisterView

urlpatterns = [
    path('me/', user_profile, name='profile_user'),
    path('user/create/', UserRegisterView.as_view(), name='create_user'),
